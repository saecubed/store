...
<header>
    ...
    <?php 
        ...
        while ($result = mysqli_fetch_array($sql)) {
            echo '<h1>'.$result['name'].'</h1>'.'<img src="'.$result['img'].'" width="150" height="250">'.'<h2>Описание: '.$result['description'].'</h2><h3>Цена: '.$result['price'].'</h3><h4>Осталось в магазине: '.$result['count'].'</h4>';
        }
